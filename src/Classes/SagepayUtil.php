...
class SagepayUtil
{
     ...
     */
    public static function availableCards(array $availableCards)
    {
        $cardArr = [];
     ...
     */
    protected static function addPKCS5Padding($input)
    {
        $blockSize = 16;
        $padd = "";
     ...
     */
    protected static function removePKCS5Padding($input)
    {
        $blockSize = 16;
     ...
     * @throws SagepayApiException
     */
    public static function decryptAes($strIn, $password)
    {
    ...
    public static function arrayToQueryStringRemovingSensitiveData(array $data, array $nonSensitiveDataKey, $delimiter = '&', $urlencoded = false)
    {
        $queryString = '';
        $delimiterLength = strlen($delimiter);
